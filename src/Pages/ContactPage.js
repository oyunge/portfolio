        ...
        <div>
            ...
            <div className="ContactPage">
                ...
                <div className="contact-sect">
                    <ContactItem icon={phone} text1={'+257 798699300'} text2={'+254 704182192'} title={'Phone'}/>
                    <ContactItem icon={email} text1={'edwinombati99@gmail.com'} text2={'edwin.oyunge@students'} title={'Email'}/>
                    <ContactItem icon={location} text1={'25 Paramount St, PN4 8H9 Nairobi'} text2={'Kenya'} title={'Address'}/>
                </div>
            </div>
        </div>
    )
